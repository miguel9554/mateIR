...
HIERARCHY_FILE = $(CUSTOM_SIM_DIR)/debug_output/$(MODULE_NAME)/hierarchy.json

compare:
	make -C $(PROJECT_ROOT) vcd-diff vcd1=$(CUSTOM_SIM_VCD) vcd2=$(VERILATOR_SIM_VCD) hier=$(HIERARCHY_FILE)
