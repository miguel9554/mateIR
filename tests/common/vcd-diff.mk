...
CUSTOM_SIM_VCD_HIER_FILE = $(CUSTOM_SIM_VCD_PATH).vcd
CUSTOM_SIM_VCD_FLAT_FILE = $(CUSTOM_SIM_VCD_PATH)-flatten.vcd
VERILATOR_SIM_VCD_FILE = $(VERILATOR_SIM_DIR)/waves.vcd

CUSTOM_SIM_VCD = $(CUSTOM_SIM_VCD_FLAT_FILE):$(MODULE_NAME)
...
waves:
	gtkwave $(PROJECT_ROOT)/$(CUSTOM_SIM_VCD_HIER_FILE) &>/dev/null & disown
